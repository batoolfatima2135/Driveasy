...
function App() {
  ...
  return (
    <div className="grid justify-center align-middle grid-cols-6 xl:grid-cols-9 lg:grid-cols-10 h-screen">
      {showSideBar && (
        <div
      ...
      <div
        className={
          showSideBar
            ? 'col-span-5  xl:col-span-7 lg:col-span-7'
            : 'col-span-6  xl:col-span-9 lg:col-span-10'
        }
      >
        <Routes>
